...
if ($oldversion < 2019090501) {
    ...
    $table->add_field('saml_id', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, '0', 'id');
    $table->add_field('course_id', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, '666', 'saml_id');
    ...
    $table->add_key('ajena', XMLDB_KEY_UNIQUE, ['course_id']);
